...
class ProblemSpec:
    ...
    difficulty: str
    task_type: str
    solution_fn: Callable[[Config], Grade] = field(repr=False)
    ...
    too_hard: bool
    base: str
    setup: Callable[[dict[str, Any]], Any] | None
    template: str
    test_files: list[str] | None = None
...
def problem(
    *,
    ...
    base: str,
    test_files: list[str] | None = None,
    setup: Callable[[dict[str, Any]], Any] | None = default_setup,
    template: str = "",
    golden: list[str] | None = None,
):
    def decorator(fn: Callable[[Config], Grade]):
        spec = ProblemSpec(
            id=id,
...
class Grader:
    ...
    @classmethod
    def grade(cls, state: Config, weight: float, **kwargs) -> SubGrade:
    ...
    @classmethod
    def compute_score(cls, state: Config, **kwargs) -> float | tuple[float, dict[str, Any]]:
        """
